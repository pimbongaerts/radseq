#!/usr/bin/env python
"""
Reduces FASTA file to those loci not listed in supplied text file.
"""
import sys
import argparse
...
def main(fasta_filename, list_filename):
    ...
    for line in fasta_file:
        if line[0] == '>':
            ...
            # Output sequence if not in list of loci
            print(line.strip())
...
if __name__ == '__main__':
    ...
    parser.add_argument('exclusion_filename', metavar='exclusion_file',
                        help='text file with names of loci to be excluded')
    args = parser.parse_args()
    main(args.fasta_filename, args.exclusion_filename)
